...
* add Slovak (sk) translations to all content files ([9c7ec0b](https://github.com/symonbaikov/lumio/commit/9c7ec0bea177ef260feec458b5a31e912576aef2))
...
* **backend:** add transaction enrichment infrastructure ([afa805f](https://github.com/symonbaikov/lumio/commit/afa805fec68802e0e8c064746d6142c937a35f9a))
...
* **backend:** update dashboard service and response interfaces ([7ea31cf](https://github.com/symonbaikov/lumio/commit/7ea31cf4fd06e759c59ecf61f49bc805bdddb0df))
...
* **classification:** enrich transaction classification with category metadata ([58bbb94](https://github.com/symonbaikov/lumio/commit/58bbb94d57b7628e84438bb49d46b84ac025283f))
...
* **frontend:** add @mui/x-date-pickers ([d6713ac](https://github.com/symonbaikov/lumio/commit/d6713acbdafe44ba988d7db857a29fc68de4f88e))
* **frontend:** add BEM design tokens in tokens.css ([6581939](https://github.com/symonbaikov/lumio/commit/6581939cbf123c5c0c31457c68e9b1b4deb86d3e))
...
* **frontend:** import tokens.css and base.css into globals ([ee58aee](https://github.com/symonbaikov/lumio/commit/ee58aee80d7ff10911bd3060ba67882cb5029132))
...
* **frontend:** migrate static CSS token inline styles to JS tokens ([457e753](https://github.com/symonbaikov/lumio/commit/457e753080239e7ff9d1fd577e49ee33ecda263e))
...
* **frontend:** replace lucide-react with MUI icons ([0ad80cc](https://github.com/symonbaikov/lumio/commit/0ad80ccc9b15382a79b897bc8d7e53a1212d1f7a))
* **frontend:** set borderRadius:0 overrides in MUI theme ([8de0185](https://github.com/symonbaikov/lumio/commit/8de01857b35878ee3959e86f076d816833491bfe))
...
* **frontend:** wrap app in MUI LocalizationProvider ([6dc4a0c](https://github.com/symonbaikov/lumio/commit/6dc4a0ceacc63b2d2fa78fbdfbb48c7f0373aef1))
...
* **gmail:** add receipt thumbnail and export functionality ([c7e6097](https://github.com/symonbaikov/lumio/commit/c7e60974716f5a440a6eec5b81c3d1435a18ecfe))
...
* **i18n:** expand locale foundation to support 10 languages ([5bd27ac](https://github.com/symonbaikov/lumio/commit/5bd27acde52a9a6597d30f2d758d7814daa1b88f))
* **i18n:** expand UI language selectors to use SUPPORTED_LOCALES ([83a1099](https://github.com/symonbaikov/lumio/commit/83a10998fb9a201415667a6ae060f72671fe0b49))
...
* **observability:** add Prometheus + Grafana monitoring for Railway ([c0b660b](https://github.com/symonbaikov/lumio/commit/c0b660b710a554cb357e102fbe9bf09af391bfc8))
...
* **parsing:** add Bank Hapoalim enum and DB migration ([e2953c6](https://github.com/symonbaikov/lumio/commit/e2953c69bf62064f05d748bd4199c5276329dd42))
* **parsing:** add DD/MM/YY date format support ([ae03e61](https://github.com/symonbaikov/lumio/commit/ae03e617f3a2328cb8fa77fa52ed6652e82e4d08))
* **parsing:** add Hapoalim parser with AI vision fallback ([82d17bb](https://github.com/symonbaikov/lumio/commit/82d17bbcb212085837d4bf01b078d948f4ab7070))
* **parsing:** add Hebrew language support to OCR service ([0f139cb](https://github.com/symonbaikov/lumio/commit/0f139cb55f289894bca0dae607cf843ae3192f33))
...
* **scss:** add barrel files, globals.scss entry point, update imports ([97c937b](https://github.com/symonbaikov/lumio/commit/97c937be7ded5fa03f97602bd2d255d055159796))
* **scss:** add base reset and scrollbar styles ([9da1fc4](https://github.com/symonbaikov/lumio/commit/9da1fc429bcc9d984d8a7cc5276fbde27e2cc20e))
...
* **scss:** add dark-mode SCSS variables ([b6ca68b](https://github.com/symonbaikov/lumio/commit/b6ca68b55f9a0082bfdcf013d1e38e41010d20a3))
* **scss:** add global theme styles ([781602e](https://github.com/symonbaikov/lumio/commit/781602ecd03f2ed113824dc6f3f9b10a5ea219f4))
* **scss:** add JS theme tokens for inline styles migration ([cc98864](https://github.com/symonbaikov/lumio/commit/cc9886411596106159ce0892731fd1e59b742d41))
* **scss:** add light-mode SCSS variables ([b107dd9](https://github.com/symonbaikov/lumio/commit/b107dd9883c747ee6861897f7d89cc04801d7045))
* **scss:** add SCSS mixins and abstracts barrel ([eee33c7](https://github.com/symonbaikov/lumio/commit/eee33c718e029c499f8bf55eac36d211ddc0de36))
* **scss:** add Tailwind dark mode override utilities ([e954f6b](https://github.com/symonbaikov/lumio/commit/e954f6bd86527854943574b53322663d874621aa))
* **scss:** convert breadcrumbs, language-switcher, notification-dropdown, audit-panel to SCSS ([af01a7a](https://github.com/symonbaikov/lumio/commit/af01a7aeaa5c24fa1719471ad740196e6713b778))
* **scss:** convert lumio-sidebar shell to SCSS layout ([710f3b5](https://github.com/symonbaikov/lumio/commit/710f3b5d6cc1c56460f5a252c911394addc55279))
* **scss:** convert lumio-statements to SCSS ([1a848f8](https://github.com/symonbaikov/lumio/commit/1a848f8b10093f0e55043e9854f9bdcd0cad0bae))
* **scss:** convert lumio-transaction-table to SCSS ([5285b12](https://github.com/symonbaikov/lumio/commit/5285b12f7ec669bec8ece06b9668e60544873b10))
* **scss:** convert pdf-preview-modal, navigation, dashboard to SCSS ([2ddbed0](https://github.com/symonbaikov/lumio/commit/2ddbed0b2a3c34759f77c64bd81f5e3a88ba3572))
* **scss:** convert tour-theme to SCSS ([349f336](https://github.com/symonbaikov/lumio/commit/349f336703eeab1d203f245d6e6cb7f67c129222))
...
* **sidebar:** replace storage widget with support project button ([9799287](https://github.com/symonbaikov/lumio/commit/97992878c6a37234aff7afa2bf37436d91392d52))
...
* **website:** align docs site branding with main app green theme ([2692b39](https://github.com/symonbaikov/lumio/commit/2692b3960b15ace3fd91f1a6bd585bc9665c4d4a))
* **website:** align docs site branding with main app green theme ([81f87c9](https://github.com/symonbaikov/lumio/commit/81f87c9577ce3fb3b7027f08c5d29022fa17a55b))


### Bug Fixes

* add missing Slovak translations in dropbox, google-drive, and make-cloud-storage content files ([6e62909](https://github.com/symonbaikov/lumio/commit/6e62909ea41ecc70dd4c8ff692a3715eeb3fdc31))
* add missing Slovak translations to content files ([f5b3f96](https://github.com/symonbaikov/lumio/commit/f5b3f96b1871bad8ff92d9f39a9ffbb3d3de251b))
* add sk self-reference in navigation.content.ts languages.sk entry ([71f182d](https://github.com/symonbaikov/lumio/commit/71f182dd860e768da0a6ae6a66ac23464c7e6702))
...
* **backend:** replace inline import() type with top-level import ([f4626f6](https://github.com/symonbaikov/lumio/commit/f4626f64faab55721b9e5b531cd3e1fd0b3ab2e1))
* **categories:** make toggle switch knob visibly white ([0783e60](https://github.com/symonbaikov/lumio/commit/0783e6061b76d67493a163181520a3f9ddbb959e))
...
* correct sk translations formatting in storage and integration content files ([1ea1f8b](https://github.com/symonbaikov/lumio/commit/1ea1f8b8471cc3cc7517b05b0eb0424b434b91d4))
...
* **frontend:** add contentClassName prop to ModalShellProps ([8331927](https://github.com/symonbaikov/lumio/commit/8331927eb2daaacd989e3e9c907d21f858b7a006))
* **frontend:** add missing dark mode surface tokens in tokens.css ([2b73f26](https://github.com/symonbaikov/lumio/commit/2b73f263671474a44466033d30249dfea797b4ae))
* **frontend:** add semantic warning/error surface tokens, fix hover state token in receipts ([57d6d3c](https://github.com/symonbaikov/lumio/commit/57d6d3cf866ddea435e8aa44c6b145f34cdae85e))
* **frontend:** align refactored hooks with tightened types from main ([b8ab191](https://github.com/symonbaikov/lumio/commit/b8ab191e62f0f575470f71f1d65117a6bde3b56d))
* **frontend:** align useEditableCell ref type with React 19 ([121f054](https://github.com/symonbaikov/lumio/commit/121f054a30b806b0f5447e8a738418f8e1974e3c))
* **frontend:** explicit null check in isSupportedLocale guard ([0dfd3b7](https://github.com/symonbaikov/lumio/commit/0dfd3b763fea1666fb415f7c165a0d061639e3c8))
* **frontend:** fix #fff fallbacks in lumio-statements.css CSS vars ([c536fd8](https://github.com/symonbaikov/lumio/commit/c536fd8aef0b5961bbf1d658361fdda46249e82f))
* **frontend:** fix build errors for production deployment ([f3e61f4](https://github.com/symonbaikov/lumio/commit/f3e61f4646bf55afa35f5bd69591621d7480ae8d))
* **frontend:** fix conditional #fff backgrounds in StoragePageContent ([06603a5](https://github.com/symonbaikov/lumio/commit/06603a509de3dcba412709c7de7932cd96958d40))
* **frontend:** fix DrawerShell sx prop typing, surface-glow color, hardcoded white ([552ccff](https://github.com/symonbaikov/lumio/commit/552ccff2d15cb56736557639291baf62696e3c32))
...
* **frontend:** fix missed whites and wrong action.hover token in shared components ([225cf13](https://github.com/symonbaikov/lumio/commit/225cf13f2959cd17b103d03523fb6764cb253799))
* **frontend:** fix ModalShell className prop, PDF modal whites, build error ([1a29dcb](https://github.com/symonbaikov/lumio/commit/1a29dcbcc26e0eb6b3bf198e7ad3a08be9ba4806))
* **frontend:** fix remaining conditional and isDark white backgrounds in custom-tables, workspaces, statements ([5726f3b](https://github.com/symonbaikov/lumio/commit/5726f3b2d238338ec7346592dde7f63eb5fd29a8))
...
* **frontend:** fix remaining hardcoded whites in statements components ([e88a5c6](https://github.com/symonbaikov/lumio/commit/e88a5c647d6f4be65c6125f0609745f42e37b54a))
* **frontend:** fix token misuse and missed white backgrounds in dashboard/integrations ([e313a23](https://github.com/symonbaikov/lumio/commit/e313a23e74dcfed110fe2a8c5919b2037b985ef7))
* **frontend:** fix UI bugs and replace logo with logo.jpg ([e797cd8](https://github.com/symonbaikov/lumio/commit/e797cd8bb08034b5e9f402e8684dcf86b27aa0c8))
* **frontend:** fix UI bugs and replace logo with logo.jpg ([85f9b6f](https://github.com/symonbaikov/lumio/commit/85f9b6f801e8f590d4fc1132eb4d1a6df494ba35))
* **frontend:** quality fixes in Stage 2 components — deps, placeholder, CSS, dark mode ([dd35127](https://github.com/symonbaikov/lumio/commit/dd35127e6e0f2b1781977e36beaabd9ce4198cb4))
* **frontend:** quality fixes in ui/ primitives — z-index, prop forwarding, state sync ([8f3282d](https://github.com/symonbaikov/lumio/commit/8f3282d8eb4c2d220e4347e509d55359027e7cff))
* **frontend:** remove dead import and Tailwind classes in auth animation components ([6e0dc11](https://github.com/symonbaikov/lumio/commit/6e0dc11ac2ab57001342a01fe068514e2140b383))
* **frontend:** remove redundant borderRadius: 0 from mobile checkbox ([a5ba48f](https://github.com/symonbaikov/lumio/commit/a5ba48f214d80f404d55cfb26b0688589297e776))
...
* **frontend:** restore unread dot circle shape, fix breadcrumbs var-based radius ([b53a797](https://github.com/symonbaikov/lumio/commit/b53a7978c363e9537f5d14a6f52e8dd09a1d8a56))
* get ridd of any type in the whole production code base an ([1b42796](https://github.com/symonbaikov/lumio/commit/1b427965a1f86e8204d0f65fa911f7f2e51f9a72))
...
* **observability:** fix Prometheus envsubst and Grafana permissions ([1cfe2aa](https://github.com/symonbaikov/lumio/commit/1cfe2aabe425172d0705fb63ee98559a035d5a2f))
* **observability:** fix Railway deploy for Prometheus and Grafana ([3dacc73](https://github.com/symonbaikov/lumio/commit/3dacc73ec1e37059f5ec9f77a83a499ce1672151))
* **observability:** move dashboards outside volume mount path ([f5f8ce3](https://github.com/symonbaikov/lumio/commit/f5f8ce331338e70782a08a0082b981b384eeb5ab))
* **observability:** remove alerting provisioning, fix Prometheus ([a749b70](https://github.com/symonbaikov/lumio/commit/a749b7044612f3ffd86610aee6bd0555242b2d6c))
* **observability:** use sed instead of envsubst for Prometheus ([4489ea9](https://github.com/symonbaikov/lumio/commit/4489ea98c4a68070bf82f5b32ada1d9263afcf46))
...
* remove duplicate React import in EntityHistoryTimeline ([d200b7d](https://github.com/symonbaikov/lumio/commit/d200b7d31cd284c4a10be7836efca0896bcea99b))
* remove unused AppLocale ghost imports from navigation-config and useOnboardingWizard ([719b25c](https://github.com/symonbaikov/lumio/commit/719b25c3698e6a1d230498ec4ffa27d0713b387f))
...
* **scss:** replace all remaining var(--) references with SCSS variables ([35fbc5a](https://github.com/symonbaikov/lumio/commit/35fbc5a166143f95052c34c803dcc1d5ac464c54))
* **statements:** fix filter dropdowns and Gmail receipt amount display ([cd2ad64](https://github.com/symonbaikov/lumio/commit/cd2ad647e7ab9bc7d72815331f3eb73a2f57471a))
...
* update Dockerfile and intlayer config ([f8ca7b9](https://github.com/symonbaikov/lumio/commit/f8ca7b93fbf207a162c68c590d0b942c7676c379))
* use DEFAULT_LOCALE fallback and extract availableLocales mapping in language selectors ([3bbbfd2](https://github.com/symonbaikov/lumio/commit/3bbbfd2aecae5d1b22320508e1f3b6544431d1d4))
