import type { OnboardingIntegrationKey } from '@/app/(onboarding)/onboarding/hooks/useOnboardingActions';
import type {
  ConfigField,
...
type DialogProtocolConfig = Omit<ProtocolIntegrationPageProps, 'embedded' | 'onStatusChange'>;
...
const WEBDAV_FIELDS: ConfigField[] = [
  {
    name: 'url',
    label: 'WebDAV URL',
...
const APP_URL_FIELDS: ConfigField[] = [
  {
    name: 'publicUrl',
    label: 'Public URL',
...
export const PROTOCOL_CONFIGS: Partial<Record<OnboardingIntegrationKey, DialogProtocolConfig>> = {
  s3Compatible: {
