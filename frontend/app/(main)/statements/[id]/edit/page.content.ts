...
const content = {
  ...
  content: {
    ...
    labels: {
      ...
      submitForApproval: t({ ru: 'Отправить', en: 'Submit', kk: 'Жіберу' }),
      submitSuccess: t({
        ru: 'Выписка отправлена на утверждение',
        en: 'Statement submitted for approval',
        kk: 'Үзінді бекітуге жіберілді',
      }),
      categoryButton: t({ ru: 'Категория', en: 'Category', kk: 'Санат' }),
      categoryDrawerTitle: t({ ru: 'Категория', en: 'Category', kk: 'Санат' }),
      categorySearchPlaceholder: t({ ru: 'Поиск', en: 'Search', kk: 'Іздеу' }),
      categoryAllOption: t({ ru: 'Все', en: 'All', kk: 'Барлығы' }),
      categoryNoResults: t({
