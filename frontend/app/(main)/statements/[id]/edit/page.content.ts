...
const content = {
  ...
  content: {
    ...
    labels: {
      ...
      submitSuccess: t({ ru: 'Выписка отправлена на утверждение', en: 'Statement submitted for approval', kk: 'Үзінді бекітуге жіберілді' }),
      ...
      categoryNoResults: t({ ru: 'Категории не найдены', en: 'No categories found', kk: 'Санаттар табылмады' }),
      categoryUpdated: t({ ru: 'Категория выписки обновлена', en: 'Statement category updated', kk: 'Үзінді санаты жаңартылды' }),
      categoryUpdateFailed: t({ ru: 'Не удалось обновить категорию выписки', en: 'Failed to update statement category', kk: 'Үзінді санатын жаңарту мүмкін болмады' }),
      unapprove: t({ ru: 'Снять с утверждения', en: 'Unapprove', kk: 'Бекітуден қайтару' }),
      pay: t({ ru: 'Оплатить', en: 'Pay', kk: 'Төлеу' }),
      rollbackToApprove: t({ ru: 'Вернуть на утверждение', en: 'Return to approve', kk: 'Бекітуге қайтару' }),
      ...
      unapproveSuccess: t({ ru: 'Выписка возвращена в Submit', en: 'Statement moved back to submit', kk: 'Үзінді Submit кезеңіне қайтарылды' }),
      paySuccess: t({ ru: 'Выписка переведена в Pay', en: 'Statement moved to pay', kk: 'Үзінді Pay кезеңіне ауыстырылды' }),
      rollbackToApproveSuccess: t({ ru: 'Выписка возвращена на утверждение', en: 'Statement moved back to approve', kk: 'Үзінді бекіту кезеңіне қайтарылды' }),
    },
    columns: {
