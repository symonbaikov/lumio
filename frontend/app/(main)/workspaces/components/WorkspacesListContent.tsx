...
import { ChevronRight, Grid, List, MoreVertical, Search, SortAsc } from 'lucide-react';
...
export default function WorkspacesListContent({
  ...
  const getWorkspaceInitial = (name: string) => {
    ...
    return trimmedName.length > 0 ? trimmedName.charAt(0).toUpperCase() : 'W';
  };
                    ...
                    {filteredAndSortedWorkspaces.map(workspace => (
                      ...
                      >
                        <div className="flex min-w-0 items-center gap-3">
                          <span className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-emerald-400/90 text-base font-semibold text-emerald-950">
