...
const subscriptions = [
  { vendorName: 'Claude', status: 'active', ownerId: 'user-1', category: { name: 'AI' }, riskStatus: 'price_changed' },
  { vendorName: 'Figma', status: 'active', ownerId: 'user-2', category: { name: 'Design' }, riskStatus: 'none' },
];
