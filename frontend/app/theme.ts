...
const getSharedOptions = (
  ...
  return {
    ...
    typography: {
      ...
      h3: { fontWeight: 680, fontSize: '1.75rem', letterSpacing: '-0.015em' },
      h4: { fontWeight: 660, fontSize: '1.5rem', letterSpacing: '-0.01em' },
      h5: { fontWeight: 640, fontSize: '1.25rem' },
      h6: { fontWeight: 620, fontSize: '1rem' },
