...
@Module({
  imports: [TypeOrmModule.forFeature([Subscription, SubscriptionCharge, SubscriptionDecision, Transaction, Workspace, WorkspaceMember]), NotificationsModule, ExchangeRatesModule],
